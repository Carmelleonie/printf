...
/* Lenght Modifier Macros */
#define SHORT 1
#define LONG 2

/**
*struct buffer_s - A new type defining a buffer struct.
*@buffer: A pointer to character array.
*@start: A pointer to the start of buffer.
*@len: The lenght of the string stored in buffer.
*/
...
*@specifier: A character representinga conversion specifier.
...
/* Handlers */
unsigned int handle_flags(const char *flags, char *index);
unsigned int handle_lenght(const char *modifier, char *index);
...
unsigned int convert_ubase(buffer_t *output, long int num, char *base, unsigned char flags, int wid, int prec);
